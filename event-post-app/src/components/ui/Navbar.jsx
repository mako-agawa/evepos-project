    ...
    <nav className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-300 shadow-md">
      <div className="flex justify-around max-w-screen-md mx-auto items-center py-3">
        ...
        <button onClick={() => handleNavigation('index')}>
          <Link
            href="/"
            className={`flex flex-col items-center ${getActiveClass('index')} hover:text-orange-400`}
          >
        ...
        <button onClick={() => handleNavigation('schedule')}>
          <Link
            href="/"
            className={`flex flex-col items-center ${getActiveClass('schedule')} hover:text-orange-400`}
          >
        ...
        <button onClick={() => handleNavigation('search')}>
          <Link
            href="/"
            className={`flex flex-col items-center ${getActiveClass('search')} hover:text-orange-400`}
          >
        ...
        {auth.isLoggedIn && currentUser ? (
          <button onClick={() => handleNavigation('create')}>
            <Link
              href="/events/new"
              className={`flex flex-col items-center ${getActiveClass('create')} hover:text-orange-400`}
            >
          ...
          <button onClick={() => handleNavigation('login')}>
            <Link
              href="/users/login"
              className={`flex flex-col items-center ${getActiveClass('login')} hover:text-orange-400`}
            >
